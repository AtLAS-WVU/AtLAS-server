...
// Query to get the user's deliveries from the DB
$query = "SELECT * FROM deliveries WHERE sender_id='$userID' OR receiver_id='$userID'";
...
if (!$result) {
    ...
    while($row = mysqli_fetch_assoc($result)) {
        ...
        $pending_requests[] = array(
            ...
            "delivery_message"=> $row['package_message'],
            "delivery_status"=> $row['delivery_status'],
            "start_of_delivery_date"=> $row['time_stamp'],
        );
    }
    $response['success'] = TRUE;
